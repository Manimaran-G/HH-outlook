        ...
        <form id="eventForm">
            ...
            <div class="form-group">
                ...
                <select id="eventType" name="eventType" class="form-control" required>
                    <option value="event"><strong>Event</strong></option>
                    <option value="meeting"><strong>Meeting</strong></option>
                </select>
            </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const eventPayload = {
        ...
        "isOnlineMeeting": eventType === "meeting",
    };
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Gopi_WorkSpace\HH-outlook-main\resources\views/events.blade.php ENDPATH**/ ?>